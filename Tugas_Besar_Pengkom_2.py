...
print('-----------------------------------------------------------------')
#CATATAN
#NIM = INTEGER MAU JADI 
#BELUM LOOP KALO INPUT BELUM SESUAI
#BELUM LOOP KALO MAU KE MENU AWAL
            ...
            if (NIM > 16322215):
                ...
                if(Menulanjut == 1):
                    ...
                    if (JalurMasuk == 1):
                        ...
                        print(' Gedung lab kimia dasar ➝ Gedung Labtek 1')
                        print(' Tujuanmu ada tepat didepan gedung lab kimia dasar')
                        print(' Selamat praktikum pengenalan komputasi :)')
                elif(Menulanjut == 2):
                    Balik_Menu()
                    BalikMenu = int(input())
